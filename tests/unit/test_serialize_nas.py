...
class TestNasSerializer:
    ...
    def test_NasSerializer(self):
        nas_model = {
            ...
            "operations": {
                "NasOperation": {
                    ...
                    "input": {"shape": "NasOperationRequest"},
                    "name": "NasOperation",
                    "output": {"shape": "NasOperationResult"},
                }
            },
            "shapes": {
                "NasOperationRequest": {
        ...
        res = nas_serializer.serialize_to_request(params, nas_service_model.operation_model("NasOperation"))
    ...
    def test_NasSerializer_fix_get_metrics_statistics_params(self):
        nas_model = {
            ...
            "operations": {
                "GetMetricStatistics": {
                    "http": {"method": "POST", "requestUri": "/"},
                    "input": {"shape": "GetMetricStatisticsRequest"},
                    "name": "GetMetricStatistics",
                    "output": {"resultWrapper": "NasOperationResult", "shape": "NasOperationResult"},
                },
            },
            "shapes": {
        ...
        params = {}
        nas_serializer = serialize.NasSerializer()
        res = nas_serializer.serialize_to_request(params, nas_service_model.operation_model("GetMetricStatistics"))
        assert res["body"] == {"Action": "GetMetricStatistics", "Version": "N2016-02-24"}
        assert res["headers"] == {"Content-Type": "application/x-www-form-urlencoded; charset=utf-8"}
        assert res["method"] == "POST"
        assert res["query_string"] == ""
        assert res["url_path"] == "/"
