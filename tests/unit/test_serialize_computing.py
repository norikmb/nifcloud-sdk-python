...
class TestComputingSerializer:
        ...
        computing_model = {
            ...
            "operations": {
                "ComputingOperation": {
                    ...
                    "input": {"shape": "ComputingOperationRequest"},
                    "name": "ComputingOperation",
                    "output": {"shape": "ComputingOperationResult"},
                }
            },
            "shapes": {
    ...
    def test_ComputingSerializer_fix_user_data_param(self, api_name):
        computing_model = {
            ...
            "shapes": {
                "ComputingOperationRequest": {
                    "members": {"UserData": {"locationName": "UserData", "shape": "RequestUserData"}},
                    "name": "ComputingOperationRequest",
                    "type": "structure",
                },
                "ComputingOperationResult": {
                ...
                "RequestUserData": {
                    "members": {
                        "Content": {"locationName": "Content", "shape": "String"},
                        "Encoding": {"locationName": "Encoding", "shape": "String"},
                    },
        ...
        computing_service_model = ServiceModel(computing_model)
        params = {"UserData": {"Content": "test_content", "Encoding": "test_content_encoding"}}
        computing_serializer = serialize.ComputingSerializer()
    ...
    def test_ComputingSerializer_fix_describe_load_balancers_params(self):
            ...
            "shapes": {
                "DescribeLoadBalancersRequest": {
                    "members": {
                        ...
                        "Patamator": {"locationName": "Patamator", "shape": "String"},
                    },
                    "name": "DescribeLoadBalancersRequest",
                    "type": "structure",
                },
                "ListOfRequestLoadBalancerNames": {
                    "member": {"locationName": "member", "shape": "RequestLoadBalancerNames"},
                    "name": "ListOfRequestLoadBalancerNames",
                    "type": "list",
                },
                "RequestLoadBalancerNames": {
                    "members": {
                        "InstancePort": {"locationName": "InstancePort", "shape": "Integer"},
                        "LoadBalancerName": {"locationName": "LoadBalancerName", "shape": "String"},
                        "LoadBalancerPort": {"locationName": "LoadBalancerPort", "shape": "Integer"},
                    },
        ...
        assert res["body"] == {"Action": "DescribeLoadBalancers", "Version": "3.0"}
        assert res["headers"] == {"Content-Type": "application/x-www-form-urlencoded; charset=utf-8"}
        assert res["method"] == "POST"
        assert res["query_string"] == ""
        assert res["url_path"] == "/api/"
