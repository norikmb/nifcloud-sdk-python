"""NIFCLOUD configuration provider setup.

Configures botocore's session variables to use NIFCLOUD-specific
environment variables and default configuration file paths.
"""
...
configprovider.BOTOCORE_DEFAUT_SESSION_VARIABLES.update(
    {
        ...
        "credentials_file": (None, "NIFCLOUD_SHARED_CREDENTIALS_FILE", "~/.nifcloud/credentials", None),
    }
)
