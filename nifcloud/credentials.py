"""NIFCLOUD credential provider configuration.

Configures botocore's credential providers to use NIFCLOUD-specific
environment variables and credential file formats.
"""
